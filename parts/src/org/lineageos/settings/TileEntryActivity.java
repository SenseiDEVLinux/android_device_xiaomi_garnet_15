...
public class TileEntryActivity extends Activity {
    ...
    private static final String GAMEBAR_TILE = "org.lineageos.settings.gameoverlay.GameOverlayTileService";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (REFRESH_TILE.equals(sourceClassName)) {
            ...
            intent = new Intent(this, GameOverlaySettingsActivity.class);
        } else {
